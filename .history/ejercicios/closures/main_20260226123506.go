...
func main() {
	...
	doble := NuevoMultiplicador(2)

	// Mostrar información sobre la función closure
	fmt.Printf("Tipo de la función doble: %T\n", doble)
	fmt.Printf("Valor de la función doble: %v\n", doble)
	fmt.Printf("Dirección de la función doble: %p\n", doble)
	fmt.Println("\nEjemplo de uso:")

	println("Doble puntos:", doble(50))
