...
func emiteSuma(numeros []int, c chan<- int, wg *sync.WaitGroup, cantidadDeGoroutinas int) {

	log.Printf("Goroutines en ejecución: %d", cantidadDeGoroutinas)
