...
// TODO: Crear un tipo pseudo enumerado
const (
	SET tipoMetodo = "Set"
	GET tipoMetodo = "Get"
)
...
func metodoAInvocar(k string, userDtoValue reflect.Value, tipo tipoMetodo) (string, reflect.Value) {
	...
	slog.Info("Método a invocar: [%s].", methodName)
