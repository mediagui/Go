...
import (
	...
	"concesionarioEncapsulamiento/vehiculo" // Importo el paquete local de gestión de vehículos.
...
Modificar el programa que permite gestionar un concesionario, creando automóviles, de manera que los elementos de automóvil creado, se manejen con el método de encapsulamiento. Para ello, se deberán modificar los campos oportunos y estipular los métodos pertinentes (get y  set).
*/
