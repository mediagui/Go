...
- **Web frameworks**
  - [Gin](https://github.com/gin-gonic/gin)
    Framework web HTTP de alto rendimiento, Martini-like pero 40x más rápido con httprouter. Soporta middleware, routing, JSON validation y crash-free.zuplo+1.
  - [Fiber](https://github.com/gofiber/fiber)
    Framework rápido inspirado en Express.js, usa fasthttp para velocidad extrema. Ideal para APIs de alto tráfico con sintaxis familiar.monocubed​
  - [Echo]( https://github.com/labstack/echo)
    Framework minimalista y extensible con router optimizado, middleware, data binding y HTTP/2. Equilibrado para REST escalables.monocubed​
  - [Gorilla Mux](https://github.com/gorilla/mux)
    Router potente y modular con matching avanzado de paths, queries y headers. Madura y usada en enterprise.monocubed​
  - [Chi](https://github.com/go-chi/chi)
    Router ligero  compatible con stdlib net/http. Perfecto para microservicios simples y middleware chaining.monocubed​
- [Open Api]( https://github.com/go-openapi)
